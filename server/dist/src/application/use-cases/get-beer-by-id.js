...
let GetBeerById = class GetBeerById {
    ...
    async execute(request) {
        ...
        return beer !== null && beer !== void 0 ? beer : null;
    }
};
GetBeerById = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [beers_repository_1.BeersRepository])
], GetBeerById);
exports.GetBeerById = GetBeerById;
//# sourceMappingURL=get-beer-by-id.js.map